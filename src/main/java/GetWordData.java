...
//    private final String API_key = "W+vh5nItJvK8jXhbKH2x0g==JJe0UK88tZZBGS1n";
    ...
    public String getWord() {
        ...
        if (Objects.equals(this.topic, "nature")){
            ...
            return foodList[(int) (Math.random() * natureList.length)];
        }else if (Objects.equals(this.topic, "sport")) {
            return sportList[(int) (Math.random() * natureList.length)];
        }else if (Objects.equals(this.topic, "body")) {
            return bodyList[(int) (Math.random() * natureList.length)];
        }else if (Objects.equals(this.topic, "animal")) {
            return animalList[(int) (Math.random() * natureList.length)];
        }else if (Objects.equals(this.topic, "travel")) {
            return travelList[(int) (Math.random() * natureList.length)];
        }
...
//        }
    ...
    private final String[] natureList = {"Abundant", "Aquatic", "Azure", "Bedrock", "Breeze", "Burrow", "Canopy", "Cliff", "Cloud", "Coral", "Current", "Debris", "Desert", "Dew", "Dirt", "Driftwood", "", "Earth", "Eddy", "Ephemeral", "Evergreen", "Fawn", "Forest", "Frost", "Glacier", "Grass", "Gully", "Habitat", "Horizon", "Humidity", "Ice", "Insect", "Iridescence", "Lake", "Lichen", "Meadow", "Mist", "Mountain", "Mud", "Nest", "Oasis", "Ocean", "Osprey", "Palm", "Pebble", "Plain", "Plankton", "Pod", "Predator", "Rain", "Reef", "River", "Sand", "Sapling", "Savannah", "Shore", "Sky", "Sleet", "Soil", "Sound", "Spring", "Star", "Stream", "Sun", "Swamp", "Taiga", "Temperate", "Tide", "Topography", "Tree", "Tundra", "", "Twilight", "Undergrowth", "Valley", "Vegetation", "Volcano", "Water", "Weather", "Wind", "Zephyr", "Algae", "Arctic", "Bamboo", "Bark", "Bog", "Boulder", "Canyon", "Coral Reef", "Cypress", "Desert Dune", "Ecology", "Erosion", "Fern", "Forest Fire", "Glacier", "Grassland", "Geyser", "Glade", "", "Grove", "Heat Wave", "Hurricane", "Iceberg", "Jungle", "Lake", "Lichen", "Lush", "Marsh", "Meadow", "Monsoon", "Mountain Range", "Oasis", "Ocean Current", "Owl", "Pine", "Prairie", "Rainforest", "Ridge", "Rockslide", "Savannah", "Solstice", "Sparrow", "Swamp", "Temperate Forest", "Thunderstorm", "Tundra", "", "Volcano", "Wetland", "Wilderness", "Windstorm", "Yellowstone", "", "Pond", "Fern", "Sailors", "Fishermen", "Moonlight", "Moon", "Floods", "Volcano", "Rainforest", "Ecosystem", "Dandelion", "Scientists", "Nature Lovers", "Cave", "Sand", "Earth", "Fauna", "Landscape", "Alpenglow", "Photosynthesis", "", "Heron", "Pastures", "Cliff", "High Mountains", "Twigs", "Horizon", "Ripples", "Landmarks", "Acorn", "Moorland", "Climbers", "Farmers", "Freeze", "Stream", "Nectar", "Northamptonshire", "Shepherds", "Heron", "Cygnet", "East Anglia", "Newt", "Otter", "Kingfisher", "Lark", "Bluebell", "Natural Environment", "Environment", "Natural", "Eggs", "Ash", "Wings", "Beak", "Shadow", "Rising Sun", "Fungus", "Crofters", "Shower", "Heather"};
    private final String[] foodList   = {"Appetizer", "Aroma", "Bake", "Bland", "Course", "Cuisine", "Cutlery", "Dairy product", "Delicious", "Dessert", "Diet", "Entrée", "Fast food", "Flavour", "Fry", "Grain", "Grill", "Healthy", "Hungry", "Ingredients", "Junk food", "Kettle", "Knife", "Ladle", "Meal", "Menu", "Nutritious", "Organic", "Palate", "Pantry", "Plate", "Recipe", "Restaurant", "Roast", "Salad", "Savoury", "Seasoning", "Serve", "Simmer", "Snack", "Spices", "Spoon", "Steam", "Sweet", "Table", "Taste", "Tasty", "Utensils", "Vegan", "Vegetables", "Whisk", "Yummy", "Zest", "Zucchini"};
    ...
    private final String[] bodyList   = {"Anatomy", "Person", "Organ", "Body", "Muscle", "Bone", "Skin", "Blood", "Heart", "Brain", "Lung", "Stomach", "Nerve", "Cell", "Tissue", "Joint", "Spine", "Liver", "Kidney", "Skeletal", "Digestive", "Respiratory", "Circulatory", "Immune", "Endocrine", "Sensory", "Metabolism", "Epidermis", "Pulse", "Vein", "Artery", "Capillary", "Esophagus", "Pancreas", "Thyroid", "Adrenal", "Gland", "Cartilage", "Lymph", "Spleen", "Bladder", "Intestine", "Reproductive", "Uterus", "Ovary", "Testicle", "Thymus", "Pituitary", "Gallbladder", "Bronchus", "Trachea", "Diaphragm", "Vertebra", "Femur", "Radius", "Tendon", "Ligament", "Cranium", "Pelvis", "Phalanges", "Axial", "Appendicular", "Dermis", "Cerebellum", "Cornea", "Retina", "Eardrum", "Cochlea", "Pupil", "Iris", "Sweat", "Saliva", "Mucus", "Enzyme", "Hormone", "Antibody", "White blood cell", "Red blood cell", "Platelet", "Neuron", "Synapse", "Axon", "Dendrite", "Myelin", "Cervical", "Thoracic", "Lumbar", "Sacral", "Coccyx", "Clavicle", "Scapula", "Humerus", "Ulna", "Radius", "Fibula", "Tibia", "Metatarsal", "Phalanges", "Sternum", "Ribs"};
    private final String[] animalList = {"frog", "frogspawn", "newt", "tadpole", "toad", "harvestman", "scorpion", "spider", "tarantula", "albatross", "biddy", "blackbird", "canary", "crow", "cuckoo", "dove,", "pigeon", "duck", "eagle", "falcon", "finch", "flamingo", "goose", "gull", "hawk", "jackdaw", "jay", "kestrel", "kookaburra", "mallard", "nightingale", "nuthatch", "ostrich", "owl", "parakeet", "parrot", "peacock", "pelican", "penguin", "pheasant", "piranha", "raven", "robin", "rooster", "sparrow", "stork", "swallow", "swan", "swift", "tit", "turkey", "vulture", "woodpecker", "wren", "peacock butterfly", "red admiral", "silkworm", "swallowtail", "barbel", "carp", "cod", "crab", "eel", "goldfish", "haddock", "halibut", "jellyfish", "lobster", "perch", "pike", "plaice", "ray", "salmon", "sawfish", "scallop", "shark", "shell", "shrimp", "trout", "ant", "aphid", "bee", "beetle", "bumblebee", "caterpillar", "cockroach", "dragonfly", "flea", "fly", "gadfly", "grasshopper", "harvestman", "ladybug", "larva", "lousemaggot", "midge", "moth", "nymph", "wasp", "anteater", "antelope", "armadillo", "badger", "bat", "bear", "beaver", "bullock", "camel", "chimpanzee", "dachshund", "deer, hart", "dolphin", "elephant", "elk , moose", "fox", "gazelle", "gerbil", "giraffe", "goat", "grizzly bear", "guinea pig", "hamster", "hare", "hare", "hedgehog", "horse", "hyena", "lion", "llama", "lynx", "mammoth", "marmot", "mink", "mole", "mongoose", "mouse", "mule", "otter", "panda", "pig, hog", "platypus", "polar bear", "polecat", "pony", "porcupine", "prairie dog", "puma", "racoon", "rat", "reindeer", "rhinoceros", "seal", "seal", "sheep", "skunk", "sloth", "squirrel", "tiger", "weasel", "whale", "wolf", "zebra", "slug", "snail", "blindworm", "boa", "chameleon", "constrictor snake", "copperhead", "coral snake", "cottonmouth", "crocodile", "diamondback rattlesnake", "gecko", "iguana", "lizard", "Mojave rattlesnake", "poisonous / venomous snake", "python", "salamander", "saurian", "sea snake", "sidewinder", "snake", "Southern Pacific rattlesnake", "tortoise, turtle", "tapeworm", "leech", "earthworm", "round worm", "millipede", "Thanks to H. Wirth"};
